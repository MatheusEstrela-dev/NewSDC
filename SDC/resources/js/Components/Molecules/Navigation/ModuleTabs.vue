<template>
  <div class="w-full module-tabs-container">
    <!-- Seletor de Abas - Mobile Optimized -->
    <div class="module-tabs-wrapper bg-slate-100 dark:bg-slate-800/30 rounded-xl p-1.5 mb-6 relative">
...
<script setup>
/**
 * Abas de modulo -- o DESENHO PADRAO do projeto.
 *
 * Nasceu no RAT e virou generico por decisao de projeto: trilho arredondado
 * cinza, aba ativa como pilula branca com borda inferior azul, inativas so com
 * icone abaixo de `sm`, badge de contagem e cadeado para aba bloqueada.
 *
 * Duas decisoes que o desenho carrega e que nao devem ser desfeitas:
 *
 *  - A aba ATIVA sempre mostra o nome; as inativas so a partir de `sm`. Rotular
 *    todas passaria de tres telas de largura; nao rotular nenhuma deixava o
 *    usuario sem saber em que etapa esta.
 *  - Os fades nas bordas dizem que ha mais aba fora da vista. Sem eles a tira
 *    rola, mas nada indica que rola.
 *
 * `activeTab` aceita Number ou String: o RAT numera etapas, outros modulos
 * usam chave textual.
 */
import { computed, ref, onMounted, onUnmounted } from 'vue';

const props = defineProps({
  // Number ou String: o RAT numera as etapas, outros modulos usam chave.
  activeTab: {
    type: [Number, String],
    default: 1,
  },
