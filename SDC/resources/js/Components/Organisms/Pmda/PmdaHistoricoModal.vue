    ...
    <div class="bg-slate-900 text-slate-200">
      ...
      <div class="p-6 max-h-[60vh] overflow-y-auto">
        ...
        <div v-if="activeTab === 'timeline'">
          ...
          <div v-else class="text-center py-10 text-slate-400">Nenhum evento registrado.</div>
        </div>
        ...
        <div v-else-if="activeTab === 'analises'">
          ...
          <div v-else class="text-center py-10 text-slate-400">Nenhuma análise registrada.</div>
        </div>
