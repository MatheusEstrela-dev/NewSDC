<template>
  <div @click.stop class="notifications-panel w-full sm:w-96 bg-slate-900 rounded-xl shadow-2xl border border-slate-700/50 overflow-hidden flex flex-col max-h-[calc(100dvh-5rem)] sm:max-h-[85vh]">
    <!-- Header -->
