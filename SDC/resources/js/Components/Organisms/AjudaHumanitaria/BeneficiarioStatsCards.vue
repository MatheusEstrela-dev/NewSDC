<template>
  <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 mb-4 md:mb-6">
...
import HomeModernIcon from '@/Components/Icons/HomeModernIcon.vue';
