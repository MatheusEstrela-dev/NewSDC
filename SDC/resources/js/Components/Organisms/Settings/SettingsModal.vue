    ...
    <Transition leave-active-class="duration-200">
      ...
      >
        ...
        >
          <div
            v-if="isOpen"
            class="relative mb-6 w-full max-w-5xl h-[85vh] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl flex overflow-hidden border border-slate-200 dark:border-slate-800 sm:mx-auto"
            style="z-index: 10000 !important;"
          >
            <!-- Sidebar Navigation -->
            <div class="w-64 bg-slate-50 dark:bg-slate-800/50 border-r border-slate-200 dark:border-slate-800 flex flex-col flex-shrink-0">
              <div class="p-6">
            ...
            <div class="flex-1 flex flex-col min-w-0 bg-white dark:bg-slate-900">
              ...
              <!-- Footer -->
              <div class="px-8 py-5 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-900">
