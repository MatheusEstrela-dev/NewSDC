      ...
      <div class="page-header">
        <div class="header-content">
          <div class="header-left">
            <Link :href="route('admin.permissions.roles.show', role.id)" class="back-link">
            ...
            <p class="page-subtitle">Atualize nome, descrição e permissões do cargo</p>
          </div>
        </div>
      </div>
        ...
        <div class="sidebar-content">
          <div class="sticky-sidebar">
            ...
            <div class="actions-card">
              ...
              <Link :href="route('admin.permissions.roles.show', role.id)" class="btn btn-secondary btn-block">
                Cancelar
              </Link>
            </div>
          </div>
...
const submitForm = () => {
  form.put(route('admin.permissions.roles.update', props.role.id), {
    preserveScroll: true
  });
};
</script>
