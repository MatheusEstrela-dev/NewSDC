<template>
  ...
  <div class="p-6 space-y-6">
    ...
    <div v-if="viagens.meta && viagens.meta.last_page > 1" class="mt-4 rounded-lg border border-slate-200 bg-white px-4 py-3 dark:border-slate-700/50 dark:bg-slate-900/60">
