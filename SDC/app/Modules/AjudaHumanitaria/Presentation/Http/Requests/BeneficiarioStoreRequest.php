...
/**
 * Form Request: Store Beneficiário
 *
 * Validação para criação de beneficiário
 */
class BeneficiarioStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cpf' => ['nullable', 'string', 'max:14', 'unique:beneficiarios,cpf'],
