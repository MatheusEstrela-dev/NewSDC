...
use App\Modules\AjudaHumanitaria\Domain\ValueObjects\Parentesco;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;

/**
 * Entity: Membro da Família
 *
 * Representa um membro da família de um beneficiário
 */
class MembroFamilia extends Model
{
    ...
    /**
     * Relacionamento: Beneficiário responsável
     */
    ...
    /**
     * Scope: Filtrar membros com deficiência
     */
    ...
    /**
     * Scope: Filtrar crianças (< 18 anos)
     */
