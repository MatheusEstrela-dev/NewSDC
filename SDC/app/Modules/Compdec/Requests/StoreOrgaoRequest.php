...
class StoreOrgaoRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('create', Orgao::class) ?? false;
    }
    ...
    {
        return [
            'codigo' => ['nullable', 'string', 'max:50', Rule::unique('compdec_orgaos', 'codigo')],
    ...
    /**
     * Hierarquia: REDEC exige superior CEDEC, COMPDEC exige superior REDEC.
     */
    public function withValidator(\Illuminate\Validation\Validator $validator): void
    {
        $validator->after(function ($v): void {
            ...
            if (! $superiorId) {
                if ($tipo === TipoOrgao::REDEC->value || $tipo === TipoOrgao::COMPDEC->value) {
                    // Superior pode ser nulo durante implantacao mas mostra warning na UI; nao bloqueamos aqui.
                }
                return;
            }
