...
Route::prefix('pmda')->name('pmda.')->group(function () {
    Route::prefix('planos')->name('planos.')->group(function () {
        ...
        Route::put('/{plano}', [PmdaPlanoController::class, 'update'])
            ->name('update')->middleware(['can:update,plano', 'pmda.editavel']);
        ...
        Route::post('/{plano}/anexos', [PmdaPlanoController::class, 'storeAnexo'])
            ->name('anexos.store')->middleware(['can:pmda.anexos.create', 'can:territorio,plano', 'pmda.editavel']);
        ...
        Route::put('/{plano}/compdec-ficha', [CompdecFichaController::class, 'update'])
            ->name('compdec.update')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        Route::post('/{plano}/compdec-ficha/foto', [CompdecFichaController::class, 'uploadFoto'])
            ->name('compdec.foto.upload')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        Route::delete('/{plano}/compdec-ficha/foto', [CompdecFichaController::class, 'removerFoto'])
            ->name('compdec.foto.destroy')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);

        // Etapa 3: documentos (Leis e Decretos) do COMPDEC
        Route::post('/{plano}/compdec-ficha/anexos', [CompdecAnexoController::class, 'store'])
            ->name('compdec.anexos.store')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        Route::delete('/{plano}/compdec-ficha/anexos/{anexo}', [CompdecAnexoController::class, 'destroy'])
            ->name('compdec.anexos.destroy')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        ...
        Route::post('/{plano}/compdec-ficha/equipe', [CompdecEquipeController::class, 'store'])
            ->name('compdec.equipe.store')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        Route::put('/{plano}/compdec-ficha/equipe/{equipe}', [CompdecEquipeController::class, 'update'])
            ->name('compdec.equipe.update')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);
        Route::delete('/{plano}/compdec-ficha/equipe/{equipe}', [CompdecEquipeController::class, 'destroy'])
            ->name('compdec.equipe.destroy')->middleware(['can:pmda.planos.edit', 'can:territorio,plano', 'pmda.editavel']);

        // Comunidades do plano
        Route::post('/{plano}/comunidades', [ComunidadeController::class, 'store'])
            ->name('comunidades.store')->middleware(['can:pmda.comunidades.create', 'can:territorio,plano', 'pmda.editavel']);
        ...
        Route::post('/{plano}/comunidades/solicitar', [ComunidadeSolicitacaoController::class, 'store'])
            ->name('comunidades.solicitar')->middleware(['can:pmda.comunidades.solicitar', 'can:territorio,plano', 'pmda.editavel']);

        // Pontos de captacao do plano
        Route::post('/{plano}/pontos', [PlanoPontoController::class, 'store'])
            ->name('pontos.store')->middleware(['can:pmda.pontos.create', 'can:territorio,plano', 'pmda.editavel']);
        Route::delete('/{plano}/pontos/{ponto}', [PlanoPontoController::class, 'destroy'])
            ->name('pontos.destroy')->middleware(['can:pmda.pontos.delete', 'can:territorio,plano', 'pmda.editavel']);
    });

    Route::delete('/comunidades/{comunidade}', [ComunidadeController::class, 'destroy'])
        ->name('comunidades.destroy')->middleware(['can:pmda.comunidades.delete', 'pmda.editavel']);
    ...
    Route::post('/comunidades/{comunidade}/representantes', [RepresentanteController::class, 'store'])
        ->name('representantes.store')->middleware(['can:pmda.representantes.create', 'pmda.editavel']);
    Route::put('/representantes/{representante}', [RepresentanteController::class, 'update'])
        ->name('representantes.update')->middleware(['can:pmda.representantes.edit', 'pmda.editavel']);
    Route::delete('/representantes/{representante}', [RepresentanteController::class, 'destroy'])
        ->name('representantes.destroy')->middleware(['can:pmda.representantes.delete', 'pmda.editavel']);
});
