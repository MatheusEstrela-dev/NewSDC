...
> **Faixa de legacy_id nos testes: 99xxxx.** As tabelas de dominio ja carregam
> a migracao real (896 comunidades, 8.105 beneficiarios) e os testes NAO limpam o
> dominio -- beneficiario aponta para comunidade por FK. Com id baixo,
> `where('legacy_id', 9)` acha um registro de verdade e o assert mente. Semear na
> faixa 99xxxx e o que mantem os testes validos com ou sem a carga presente.
