...
unset($__errorArgs, $__bag); ?>" placeholder="CPF - Somente números" maxlength="11" value="">
...
unset($__errorArgs, $__bag); ?>" placeholder="Digite sua Senha" value="">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-7">
                            <div class="small text-muted mt-1">
                                <a href="<?php echo e(route('password.request')); ?>" class="forgot-password" aria-label="Esqueci minha senha">
