...
<body>
    <div class="login-container">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('password.email')); ?>" method="POST" id="reset-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div id="field-cpf">
                        <div class="small text-muted mt-1">
                            <input type="text" name="cpf" id="cpf" class="form-control mb-2" placeholder="CPF - Somente números" maxlength="11" value="<?php echo e(old('cpf')); ?>">
                        </div>
                    </div>
                    ...
                    <div id="field-municipio" style="display:none;">
                        <div class="mb-3">
                            <select name="id_municipio" id="id_municipio" class="js-example-basic-single form-control">
                                ...
                                <?php $__currentLoopData = $municipios ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <a href="<?php echo e(url('login')); ?>" class="back-to-login"><span class="fas fa-arrow-left mr-1"></span> Voltar ao login</a>
                        </div>
                ...
                <?php if(session('success')): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <i class="fas fa-check-circle mr-2"></i> <?php echo session('success'); ?>
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <i class="fas fa-exclamation-triangle mr-2"></i> <?php echo session('error'); ?>
