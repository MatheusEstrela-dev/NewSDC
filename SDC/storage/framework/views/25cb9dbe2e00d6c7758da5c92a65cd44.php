    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(route('password.reset', ['token' => $token, 'email' => $email])); ?>" class="btn">Redefinir Senha</a>
            </div>

            <?php if(!empty($cpf_coordenador)): ?>
                <p style="margin-top: 20px; font-size: 0.9em;"><strong>CPF do Usuário:</strong> <?php echo e($cpf_coordenador); ?></p>
            <?php endif; ?>
...
</html><?php /**PATH /var/www/resources/views/emails/password_reset_simple.blade.php ENDPATH**/ ?>